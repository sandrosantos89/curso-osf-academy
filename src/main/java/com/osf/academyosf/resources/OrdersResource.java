...
public class OrdersResource {
	...
	@GetMapping("/orders") 
	public List<Orders> lista_orders() {
		return orders_repository.findAll();
	}

	@GetMapping("/orders/{id}") 
	public Orders lista_orders_one(@PathVariable(value = "id") int id) {
	...
	public Page<Orders> lista_products(Pageable pageable) {
		return orders_repository.findAll(pageable);
	}
}
